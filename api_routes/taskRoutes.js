module.exports = function (app, pool) {
    ...
    app.get('/api/task/comments/:task_id', (req, res) => {
        ...
        pool.query(
            'SELECT comment_text, comment_date, comment_id, username, user_id FROM task_comment INNER JOIN app_user ON task_comment.user_id = app_user.user_id WHERE task_id = $1',
            [task_id]
        )
            .then(result => {
                res.status(200).send({
